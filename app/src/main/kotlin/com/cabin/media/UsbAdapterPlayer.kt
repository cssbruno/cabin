...
private const val TAG = "CABIN_PLAYER"
 ...
 * - External callers (USB read thread via CabinManager.handleMessage) call
...
class UsbAdapterPlayer(
    ...
    // ("Cabin"/"Not connected") when false, live phone metadata when true. The session
    ...
    // Cabin, but the proximate cause appears to be downstream consumer behavior
    ...
    override fun getState(): State {
        ...
        // CarLauncher Media card, ClusterMediaActivity) keep listing Cabin as a
    ...
    companion object {
        ...
        private const val PLACEHOLDER_ITEM_ID = "cabin-placeholder"
