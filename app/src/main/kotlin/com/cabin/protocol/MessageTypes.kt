...
enum class MessageType(
    ...
    // cabin_macOS/Protocol/MessageTypes.swift which models each direction separately.
    //
    ...
    // UnknownMessage, which CabinManager logs under Logger.Tags.PROTO_UNKNOWN so
...
data class AdapterConfig(
    ...
    var fps: Int = 60,
    var dpi: Int = 160,
    /** True if user explicitly selected a resolution (non-AUTO). When true, CabinManager
    ...
    /** Keep adapter communication available while an explicitly disconnected phone stays idle. */
    val autoConnectPhone: Boolean = true,
