...
/**
 * Bounded ring buffer for audio jitter compensation.
 *
 * PURPOSE:
 ...
 * Read/write operations share a short monitor. The producer is allowed to advance
 * the read cursor during overflow, so a strict lock-free SPSC implementation would
 * let the consumer overwrite that advance and briefly replay discarded audio.
 *
 * SAMPLE ALIGNMENT:
