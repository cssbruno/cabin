 ...
 *
 * This is the ACTIVE session returned by [CabinClusterService]. It works on GM AAOS
 ...
 * this session would show static text instead of navigation data. See [CabinClusterSession]
...
class ClusterMainSession : Session() {
     ...
     * returned there (it shouldn't be; CabinClusterSession is the correct choice).
     */
    private class RelayScreen(
        ...
        override fun onGetTemplate(): Template =
            NavigationTemplate
                ...
                .setNavigationInfo(
                    MessageInfo
                        .Builder("Cabin — Cluster Navigation Service")
                        .setText(
                            "Main app should appear momentarily. If this screen persists, return to the app launcher and reopen Cabin.",
                        ).build(),
                ).setActionStrip(
                    ActionStrip
                        .Builder()
