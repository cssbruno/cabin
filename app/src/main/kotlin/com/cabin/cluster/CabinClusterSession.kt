...
import com.cabin.navigation.DistanceFormatter
import com.cabin.navigation.ManeuverMapper
import com.cabin.navigation.NavigationState
import com.cabin.navigation.NavigationStateManager
import com.cabin.navigation.TripBuilder
 ...
 *
 * NOT currently active. CabinClusterService unconditionally returns [ClusterMainSession]
 ...
 *   [CabinClusterScreen] returns NavigationTemplate with RoutingInfo (maneuver, distance, road).
 *
 * TODO: Add platform-aware switch in [CabinClusterService] gated on
 ...
 */
class CabinClusterSession : Session() {
    private var screen: CabinClusterScreen? = null
    ...
    override fun onCreateScreen(intent: Intent): Screen {
        ...
        val clusterScreen = CabinClusterScreen(carContext)
...
class CabinClusterScreen(
    ...
    override fun onGetTemplate(): Template {
        ...
        return try {
            ...
            val distance = DistanceFormatter.toDistance(state.remainDistance, com.cabin.platform.MeasurementPreferences.get(carContext).unit.value)
