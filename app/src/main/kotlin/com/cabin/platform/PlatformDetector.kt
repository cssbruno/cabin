 ...
 * NOT cached at this layer — every call re-runs all detection steps. CabinManager
 * stores the returned PlatformInfo locally and forwards it to AudioConfig.forPlatform;
 * the cluster platform-switch TODO in CabinClusterService also plans to consume
...
object PlatformDetector {
    private const val TAG = "CABIN_PLATFORM"
    ...
    data class PlatformInfo(
         ...
         * platform the per-maneuver bitmap compose ([com.cabin.navigation.compose.ComposedIconStore] /
