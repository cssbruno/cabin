...
import com.cabin.navigation.Iap2RouteData
 ...
 *
 * Lifecycle:
 *   1. Route-calc arrives as `_iap2m` field in a NaviJSON message — [CabinManager] calls
...
object ComposedIconStore {
     ...
     *
     * Called by [com.cabin.CabinManager] when a `_iap2m` field is observed in a NaviJSON
