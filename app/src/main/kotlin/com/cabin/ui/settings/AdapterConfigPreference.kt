...
class AdapterConfigPreference private constructor(
     ...
     *
     * Dev convenience that mirrors the AltVideo/NavVideo gate (CabinManager "[NAVI_GATE]":
     ...
     * bindings to CabinClusterService remain active until they are otherwise torn down.
     */
    fun applyClusterComponentState(context: Context) {
        ...
        context.packageManager.setComponentEnabledSetting(
            ComponentName(context, "com.cabin.cluster.CabinClusterService"),
            newState,
