 ...
 * The single producer is {@code CabinManager}, which supplies an implementation that routes
...
public interface LogCallback {
     ...
     * and per-tag enablement (as {@code CabinManager} does in release builds).
     */
