...
android {
    ...
    defaultConfig {
        ...
        minSdk = 27
        targetSdk = 36
        versionCode = providers.environmentVariable("CABIN_VERSION_CODE").orNull?.toInt() ?: 1010
        versionName = providers.environmentVariable("CABIN_VERSION_NAME").orNull ?: "0.1.0-alpha.10"
